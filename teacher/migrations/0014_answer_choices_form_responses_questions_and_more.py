# Generated by Django 4.2 on 2023-10-20 07:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('response', models.ManyToManyField(related_name='response', to='teacher.answer')),
                ('response_to', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='response_to', to='teacher.form')),
            ],
        ),
        migrations.CreateModel(
            name='Questions',
            fields=[
                ...
                ('choices', models.ManyToManyField(related_name='choices', to='teacher.choices')),
            ],
        ),
        migrations.AddField(
            model_name='form',
            name='questions',
            field=models.ManyToManyField(related_name='questions', to='teacher.questions'),
        ),
        migrations.AddField(
            model_name='answer',
            name='answer_to',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='answer_to', to='teacher.questions'),
        ),
    ]
